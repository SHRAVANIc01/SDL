...
const username = "JohnDoe"; // You can change this to any username
...
document.getElementById("result").innerHTML += "<br>Average number of weeks in human lifetime: " + averageWeeksInLifetime;
